...
class Marketplace_Reviews_Elementor {
    ...
    public function register_widgets($widgets_manager) {
        ...
        require_once MARKETPLACE_REVIEWS_PLUGIN_DIR . 'elementor/class-widget-review-thread.php';
        ...
        $widgets_manager->register(new \MarketplaceReviews\Widget_Review_Thread());
    }
